...
##------------------------------------------------------------------
##write.table(sub_submissionFile, file="S006_ReconNetwork_Hfrac_0.866_ProfileOnly.csv", row.names=FALSE, col.names=FALSE, quote=FALSE)

##------------------------------------------------------------------
## Save all contents
##------------------------------------------------------------------
##save.image(file="S006_ReconNetwork_Hfrac_0.866_ProfileOnly.Rdata")
