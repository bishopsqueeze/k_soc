...
##------------------------------------------------------------------
write.table(sub_submissionFile, file="S004_Hfrac_0.866_Similarity.csv", row.names=FALSE, col.names=FALSE, quote=FALSE)

##------------------------------------------------------------------
## Save all contents
##------------------------------------------------------------------
save.image(file="S004_Hfrac_0.866_Similarity.Rdata")
