##------------------------------------------------------------------
## This script is used to compute similarity matrices for the "original"
## (or raw) set of egonets provided in the kaggle competition.  A
## second set of "reconstructed" egonets was ultimately produced, using
## an algorithm that attempts to predict links where none exist
## currently.  Therefore, there is a second script like this one
## that is used against the reconstructed egonets.
##------------------------------------------------------------------
